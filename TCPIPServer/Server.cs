...
namespace TCPServer
{
    ...
    public class Server
    {
        ...
        public class UserSock
        {
            ...
            public string szRoom { get { return _szRoom; } set { _szRoom = value; } }
       ...
       // public Dictionary<int, Socket > workerSockets = new Dictionary<int, Socket>();
        ...
        public void SendMessageToAllClients(byte[] message, string room)
        {
            var _room = room.Trim().ToLower();
